...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT(
        ...
        ESC_CTL,  HO_A,   HO_S,    HO_D,    HO_F,    KC_G,    KC_MUTE,                                      KC_PSTE, KC_H,    HO_J,    HO_K,    HO_L, HO_SCLN,  KC_QUOT,
        KC_LGUI,  KC_LSFT,KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_COPY, KC_COPY, KC_PGUP, KC_PGDN,  KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,  KC_HOME, KC_END,
                                            KC_LALT, LOWER,      KC_BSPC, KC_LSFT,             KC_ENT, KC_SPC,       RAISE, KC_RALT
    ),

    [_LOWER] = LAYOUT(
        _______, _______, _______, _______, _______, _______, _______,                                      _______, _______, _______, _______, _______, _______, _______,
        _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   _______, _______,                                      _______, _______, KC_BTN1, KC_BTN2, _______, _______, _______,
        _______, KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______, _______,                                      _______, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, _______, _______,
        _______, _______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, _______, _______, _______,  _______, _______, KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, _______, _______,
